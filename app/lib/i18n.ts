...
const en = {
  ...
  templatesSub: "Browse, preview, then start with a ready-made flow.",
  workMode: "Work mode",
  all: "All",
  templatePreview: "Preview",
  templatePreviewEmpty: "Select a template to see an example input and output.",
  templateExampleInput: "Example input",
  templateExampleOutput: "Example output",
  useTemplate: "Use template",
  templateApplied: "Template loaded — edit and send",

  // Multi-agent
  agentTeam: "Agent team",
  agentTeamHint: "Assign models and tasks — each agent runs on its own model.",
  agentTaskPlaceholder: "Assign a task for this agent…",
  addAgent: "Add agent",
  removeAgent: "Remove",
  enableAgent: "Toggle agent",
  multiAgentOn: "Multi-agent on",
  multiAgentRunning: "Agents working…",

  // Focus assets / canvas
  assetDock: "Key takeaways",
  assetDockEmpty: "Key points from normal chat land here.",
  clearAssets: "Clear",
  focusCanvas: "Canvas",
  focusCanvasHint: "Edit code or long drafts here",
  openCanvas: "Open canvas",
  closeCanvas: "Close canvas",
  injectToCanvas: "Open in canvas",
...
const id: Dict = {
  ...
  templatesSub: "Jelajahi, pratinjau, lalu mulai dengan alur siap pakai.",
  workMode: "Mode kerja",
  all: "Semua",
  templatePreview: "Pratinjau",
  templatePreviewEmpty: "Pilih template untuk melihat contoh input dan output.",
  templateExampleInput: "Contoh input",
  templateExampleOutput: "Contoh output",
  useTemplate: "Pakai template",
  templateApplied: "Template dimuat — edit lalu kirim",

  agentTeam: "Tim agent",
  agentTeamHint: "Tetapkan model dan tugas — tiap agent jalan di modelnya sendiri.",
  agentTaskPlaceholder: "Tugaskan tugas untuk agent ini…",
  addAgent: "Tambah agent",
  removeAgent: "Hapus",
  enableAgent: "Aktifkan agent",
  multiAgentOn: "Multi-agent aktif",
  multiAgentRunning: "Agent sedang bekerja…",

  assetDock: "Poin penting",
  assetDockEmpty: "Kesimpulan chat biasa muncul di sini.",
  clearAssets: "Bersihkan",
  focusCanvas: "Kanvas",
  focusCanvasHint: "Edit kode atau draf panjang di sini",
  openCanvas: "Buka kanvas",
  closeCanvas: "Tutup kanvas",
  injectToCanvas: "Buka di kanvas",
  copyCanvas: "Salin kanvas",
