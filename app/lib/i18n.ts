...
const en = {
  ...
  dropOverlaySub: "Release anywhere to add them to your message",
  fileAttachedOne: "Attached {name}",
...
const id: Dict = {
  ...
  dropOverlayTitle: "Lepas file untuk dilampirkan",
  dropOverlaySub: "Lepas di mana saja untuk menambahkan ke pesan",
  fileAttachedOne: "Dilampirkan {name}",
